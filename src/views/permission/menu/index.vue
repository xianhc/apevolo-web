<template>
  <div class="app-container">
      ...
      >
        ...
        >
          <el-input
            v-model="form.title"
            :style="
              form.type.toString() === '1' ? 'width: 450px' : 'width: 178px'
            "
            placeholder="菜单标题"
          />
        </el-form-item>
        ...
        <el-form-item
          v-show="
            form.iframe.toString() !== 'true' && form.type.toString() === '2'
          "
          label="组件名称"
          prop="componentName"
        >
    ...
    >
      ...
      <el-table-column
        v-if="checkPer(['menu_edit', 'menu_del'])"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudMenu from '@/api/permission/menu'
